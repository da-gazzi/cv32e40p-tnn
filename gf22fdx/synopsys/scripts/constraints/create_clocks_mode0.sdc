...
set_clock_latency -max                    $SOC_C_Latency_Max [get_clocks FLL1_CLK]
set_clock_latency -min                    $SOC_C_Latency_Min [get_clocks FLL1_CLK]
...
set_clock_latency -max                    $PER_C_Latency_Max [get_clocks FLL2_CLK]
set_clock_latency -min                    $PER_C_Latency_Min [get_clocks FLL2_CLK]
...
set_clock_latency -max                    $CLUSTER_C_Latency_Max [get_clocks FLL3_CLK]
set_clock_latency -min                    $CLUSTER_C_Latency_Min [get_clocks FLL3_CLK]
