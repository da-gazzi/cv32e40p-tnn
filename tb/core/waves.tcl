...
# add fc
set rvcores [find instances -recursive -bydu riscv_nn_core -nodu]
...
if {$rvcores ne ""} {
  set rvprefetch [find instances -recursive -bydu riscv_nn_prefetch_L0_buffer -nodu]
  ...
  add wave -group "RF"                                       $rvcores/id_stage_i/registers_i/riscv_nn_register_file_i/mem
  add wave -group "RF_FP"                                    $rvcores/id_stage_i/registers_i/riscv_nn_register_file_i/mem_fp
  ...
  add wave -group "EX Stage" -group "ALU_THRC"               $rvcores/ex_stage_i/alu_i/threshold_compress/threshold_compress_i/*
  ...
  add wave -group "EX Stage" -group "MUL"                    $rvcores/ex_stage_i/mult_i/genblk1/compressedMAC/*
...
add wave -group "ALU_THRC"               $rvcores/ex_stage_i/alu_i/threshold_compress/threshold_compress_i/*
